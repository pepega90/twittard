defmodule TwitterCloneWeb do
  ...
  def uploads_dir, do: Application.app_dir(:twitter_clone, ["priv", "static", "uploads"])
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: TwitterCloneWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TwitterCloneWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import TwitterCloneWeb.TweetComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: TwitterCloneWeb.Router,
        statics: TwitterCloneWeb.static_paths()
    end
  end
